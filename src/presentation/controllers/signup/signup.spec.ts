...
import { BAD_REQUEST, SERVER_ERROR, SUCCESS } from '../../helpers/http-helpers'
...
describe('SignUp Controller', () => {
  ...
  test('Should return 500 if EmailValidator throws', async () => {
    ...
    const httpResponse = await sut.handle(httpRequest)
    expect(httpResponse.statusCode).toBe(SERVER_ERROR)
  ...
  test('Should return 200 if AddAccount data is correct', async () => {
    ...
    const httpResponse = await sut.handle(httpRequest)
    expect(httpResponse.statusCode).toBe(SUCCESS)
